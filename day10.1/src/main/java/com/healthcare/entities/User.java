...
public class User extends BaseClass {
	...
	// Entity -> Value Type (JPA component | embeddable)
	// User HAS-A
	@Embedded// - optional anotation
	private AdhaarCard card;
	//User HAS-A List of Preferences
	@ElementCollection
	@CollectionTable(name = "user_prefs",joinColumns = @JoinColumn(name="user_id"))
